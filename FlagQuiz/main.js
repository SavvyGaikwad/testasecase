...
function finish() {
    ...
    // Store the final score and game name in localStorage
    localStorage.setItem('finalScore', amtCorrect); // Store the score in localStorage
    localStorage.setItem('gameName', 'Flag Quiz'); // Store the game name in localStorage  

    // Redirect to scoreboard.html with query parameters
    window.location.href = '../scoreboard.html?score=' + amtCorrect + '&gameName=Flag%20Quiz'; // Redirect to scoreboard.html 

    // Hide the game card and display the alert
